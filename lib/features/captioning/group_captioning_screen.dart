...
class _GroupCaptioningScreenState extends State<GroupCaptioningScreen> {
  ...
  Color _speakerColor(String speaker) {
    ...
    return AppColors.speakerPalette[hash.abs() %
        AppColors.speakerPalette.length];
  }
                  ...
                  SafeArea(
                    ...
                    child: Padding(
                      ...
                      child: Align(
                        ...
                        child: IconButton(
                          tooltip: 'Back to speaker setup',
                          onPressed: _goBackToSpeakerSetup,
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => const CaptionReviewScreen(),
                  ),
                );
              },
              backgroundColor: AppColors.accent,
